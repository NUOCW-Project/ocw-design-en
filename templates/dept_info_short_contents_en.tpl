<div class="faculty_intro">
    ...
    {eval_strip var=$dept_info.description trunc=600 del_ptag=TRUE del_videos=TRUE is_en=TRUE}...<br>
	<div align="right">
		<a href="./index.php?lang={$lang}&amp;mode=l&amp;page_type={$curr_department_abbr}_info" id="faculty_detail">Read More</a><br>
	</div>
